      ...
      >
        ...
        >
          ...
          <div className={styles.wrapper} >
            <div className={styles.item} >Full Stack Web Developer</div>
            <div className={styles.item} >MERN Developer</div>
            <div className={styles.item}>React Developer / React Native Developer </div>
            <div className={styles.item} >Enthusiastic Developer </div>
          </div>
          </div>
          <div className={styles.btn}>
            <a
              href="https://drive.google.com/file/d/1Mwrh97qficLDATyJX9lYoA-XJKWrtjut/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
              <Button
        ...
        <div
          style={{
            transform: `translateX(${offset * 2.5}px)`,
            opacity: `${offset > 300 ? "0" : offset > 160 ? ".5" : "1"}`,}}className={styles.profileImage}>
          <img src={images.dilip} alt="Profile pic"/>
        </div>
      </div>
